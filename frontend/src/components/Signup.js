          ...
          >
            ...
            >
              ...
              <input
                type="email"
                placeholder="email"
                className="border-[1px] border-[#333]/0.4 text-black w-[200px] md:w-[300px]"
                value={email}
            ...
            <button className="my-4 bg-[#1A73E8] hover:bg-opacity-90  hover:transition-opacity hover:duration-700 hover:ease-in-out w-[120px] py-2 text-center rounded-lg text-white">
              Signup
            </button>
            <button className="text-[#F9F9F9]" onClick={navigateLoginHandler}>
